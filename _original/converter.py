...
def from_csv():
    ...
    csv_to_yaml('entities.csv', '../data/datatypes', schema=['id', 'name', 'doc', 'is_pii', 'langs', 'categories', 'country', 'parent.type', 'translations.ru.name', 'translations.ru.doc', 'links.url', 'links.type', 'patterns', 'rules'], splittable=['langs', 'categories', 'country', 'patterns'], removable=['rules'])
    csv_to_yaml('patterns.csv', '../data/patterns', schema=['id', 'name', 'doc', 'semantic_type', 'stype_name', 'langs', 'country', 'links.url', 'links.type', 'rules'], splittable=['langs', 'country'], removable=['rules', 'stype_name'])
